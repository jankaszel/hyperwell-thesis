\documentclass[12pt,a4paper,headings=standardclasses]{report}
...
\lstset{language=C++,style=FiraCodeStyle,basicstyle=\ttstyle}
...
\begin{center}
  \begin{minipage}[t]{0.85\textwidth}
    {\centering\includegraphics[width=0.25\textwidth]{layout/cc-nc-nd.pdf}} \\
