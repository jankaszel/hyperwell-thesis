...
: REST endpoint for operations on an entire notebook. This endpoint supports retrieval of all of its annotations (`GET` request of respective pages or inlined container items) and creation of new a new annotation (`POST`).
