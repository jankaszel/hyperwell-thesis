...
@Fig:hyperwell-architecture illustrates an architecture with a dedicated intermediate layer [@kassel2020a]. Situated between the P2P network and the web, the gateway receives connections from both sides and acts as a peer in the decentralized network and as a HTTP server on the web.
