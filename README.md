...
You can use the [`wc` utility](https://www.freebsd.org/cgi/man.cgi?wc) to perform a word count of the thesis' contents. Simply run `wc -w source/*.md` to gather an approximate—running it on the Markdown sources should omit words generated by pandoc/LaTeX.
